...
def get_optuna_params(train_params):
    ...
    optuna_params['fine_validation_at_nth_wander'] = train_params.fine_validation_at_nth_wander
    optuna_params['fine_validation_each_nth_epoch'] = train_params.fine_validation_each_nth_epoch
